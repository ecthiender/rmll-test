...
You can find detailed description of all the queries that are supported on HasuraDB

.. toctree::
   :maxdepth: 2

   query/data.rst
   query/schema/table.rst
   query/schema/constraint.rst
   query/schema/relationship.rst
   query/schema/index.rst
...
Generic operators (all column types) :
...
.. _JSONObject: http://rfc7159.net/rfc7159#rfc.section.4
